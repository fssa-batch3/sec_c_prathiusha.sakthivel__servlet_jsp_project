 ...
 <div class="bg">
        ...
        <form id="loginpage" action="LoginServlet" method="post">
            ...
            <div class="mhd">
                ...
                <img class="img" src="https://iili.io/Hy3dOH7.png" height="150px" width="250px" alt="img">
                <br>
                <br>
                ...
                <div class="or">
                    <p>
                        Don't have an Account? <a href="./signup.jsp">Sign-up<i class="fa-sharp fa-solid fa-arrow-right"></i></a>
                    </p>
                </div>
