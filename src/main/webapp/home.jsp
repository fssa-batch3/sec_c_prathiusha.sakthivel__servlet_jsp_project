...
<body>
      ...
      <div class="main">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <button id="vegetable_button">Vegetables</button>
            <a class="fruits" href="#">Fruits</a>
          </div>
        </div>

        <a class="login" href="#">Seller</a>

        <a class="register" href="#">Sign-in</a>


        <a href="#">
          <i id="icon" class="fa-sharp fa-solid fa-bars"></i>
        </a>

        <a href="#">
          <i id="cart_icon" class="fa-solid fa-cart-shopping fa-fade"></i>
        </a>
        <p id="cartcount">0</p>
  ...
  <main>
    ...
    <div class="img1">
      ...
      <div class="bor">
        <img src="https://iili.io/J9EoMvt.jpg" height="80px" width="80px" alt="img">
        <img src="https://iili.io/J9Eo4wu.jpg" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9EosMx.jpg" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9Exots.jpg" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9ExRl2.jpg" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9ExEVj.jpg" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9Exglp.jpg" height="90px" width="90px" alt="img">
        <img src="https://iili.io/J9ExiOX.png" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9ExQxs.jpg" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9Ezqqx.jpg" height="80px" width="90px" alt="img">
        <img src="https://iili.io/J9EzRLJ.jpg" height="90px" width="100px" alt="img">
        <img src="https://iili.io/J9EzldN.jpg" height="80px" width="100px" alt="img">
      </div>
    ...
    <div class="bg">
      <div class="mainpage2">
        ...
        <div class="mpage1">
          ...
          <img class="p2" src="https://iili.io/J9EI5u9.jpg" height="300px" width="450px" alt="img">
          <div class="page2">
            <p class="fv">
              FRESH<br> VEGETABLES
            </p>
      ...
      <div class="mainpage3">
        <div class="mpage2">
          <img class="p3" src="https://iili.io/J9EId2p.jpg" height="300px" width="450px" alt="img">
          <div class="page3">
            <p class="ff">
              FRESH<br>FRUITS
            </p>
    ...
    <div class="features">
      <div class="box">
        <img class="vegimg" src="https://iili.io/J9ET2Pj.jpg" height="420px" width="300px" alt="img">
        <h2 class="heading2">
          The Future of Food is Fast,<br>Fresh & Sustainable at Greenfarm.
        </h2>
        <p class="heading3">
          We are on cusp of new agricultural revolution<br>
          that will likely reshape the way we farm, ship and<br>
          consume food.</p>
        <div class="boxes">
          <div class="box1">
            <img class="featurebox1" src="https://iili.io/J9ETNO7.png" alt="img">
            <img class="featurebox2" src="https://iili.io/J9EuP4f.png" alt="img">
          </div>
          <div class="box2">
            <img class="featurebox3" src="https://iili.io/J9EAH4j.png" alt="img">
            <img class="featurebox4" src="https://iili.io/J9EAcnn.png" alt="img">
          </div>
    ...
    <div class="background1">
      ...
      <div class="borderofbox">
        ...
        <form onsubmit="sendEmail(); reset(); return false;" id="feedback_form">
          <label>
          ...
          <br>
          <textarea id="message" cols="30" rows="3" placeholder="Your Feedback .."></textarea>
          <br>
